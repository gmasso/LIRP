...
\subsection{Problem settings and notation}

We propose a unified model that covers a broad spectrum of potential applications in which one production facility sends goods to a set \dc of distribution centers (DCs), which in turn deliver a large set of customers. 
